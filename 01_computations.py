...
# This script does all computation for experiment 1 (curve fitting)


from helpers import run_50_trials, run_spacefilling, run_failed_example

# case "GP"
run_spacefilling('synth')

# case "GP+sampling"
run_50_trials('synth','alt', 0)

# case "GP+sampling+allocation"
run_50_trials('synth','refine', 7)

# generate example for failure if starting phase is omitted
run_failed_example()
...
mc_filename = 'output/synth_mc.npz'
